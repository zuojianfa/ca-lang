...
entry:
  ...
  %n4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @7, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @6, i32 0, i32 0)), !dbg !38
  %46 = extractvalue %AA %load, 1, !dbg !38
  %n5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @8, i32 0, i32 0)), !dbg !38
  %47 = extractvalue [3 x i32] %46, 0, !dbg !38
  %n6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @9, i32 0, i32 0), i32 %47), !dbg !38
  %n7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @10, i32 0, i32 0)), !dbg !38
  %48 = extractvalue [3 x i32] %46, 1, !dbg !38
  %n8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @11, i32 0, i32 0), i32 %48), !dbg !38
  %n9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @12, i32 0, i32 0)), !dbg !38
  %49 = extractvalue [3 x i32] %46, 2, !dbg !38
  %n10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @13, i32 0, i32 0), i32 %49), !dbg !38
  %n11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @14, i32 0, i32 0)), !dbg !38
  %n12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @15, i32 0, i32 0)), !dbg !38
  %n13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @16, i32 0, i32 0), i8 10), !dbg !39
  %load14 = load %A1, %A1* %a1, align 8, !dbg !40
  %n15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @18, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @17, i32 0, i32 0)), !dbg !40
  %n16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @20, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @19, i32 0, i32 0)), !dbg !40
  %50 = extractvalue %A1 %load14, 0, !dbg !40
  %n17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @21, i32 0, i32 0), double %50), !dbg !40
  %n18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @22, i32 0, i32 0)), !dbg !40
  %n19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @24, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @23, i32 0, i32 0)), !dbg !40
  %51 = extractvalue %A1 %load14, 1, !dbg !40
  %n20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @26, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @25, i32 0, i32 0)), !dbg !40
  %n21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @28, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @27, i32 0, i32 0)), !dbg !40
  %52 = extractvalue %AA %51, 0, !dbg !40
  %n22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @29, i32 0, i32 0), i32 %52), !dbg !40
  %n23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @30, i32 0, i32 0)), !dbg !40
  %n24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @32, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @31, i32 0, i32 0)), !dbg !40
  %53 = extractvalue %AA %51, 1, !dbg !40
  %n25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @33, i32 0, i32 0)), !dbg !40
  %54 = extractvalue [3 x i32] %53, 0, !dbg !40
  %n26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @34, i32 0, i32 0), i32 %54), !dbg !40
  %n27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @35, i32 0, i32 0)), !dbg !40
  %55 = extractvalue [3 x i32] %53, 1, !dbg !40
  %n28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @36, i32 0, i32 0), i32 %55), !dbg !40
  %n29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @37, i32 0, i32 0)), !dbg !40
  %56 = extractvalue [3 x i32] %53, 2, !dbg !40
  %n30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @38, i32 0, i32 0), i32 %56), !dbg !40
  %n31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @39, i32 0, i32 0)), !dbg !40
  %n32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @40, i32 0, i32 0)), !dbg !40
  %n33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @41, i32 0, i32 0)), !dbg !40
  %n34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @42, i32 0, i32 0), i8 10), !dbg !41
  %load35 = load %A2, %A2* %a2, align 4, !dbg !42
  %n36 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @44, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @43, i32 0, i32 0)), !dbg !42
  %n37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @46, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @45, i32 0, i32 0)), !dbg !42
  %57 = extractvalue %A2 %load35, 0, !dbg !42
  %n38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @47, i32 0, i32 0)), !dbg !42
  %58 = extractvalue [2 x [2 x %AA]] %57, 0, !dbg !42
  %n39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @48, i32 0, i32 0)), !dbg !42
  %59 = extractvalue [2 x %AA] %58, 0, !dbg !42
  %n40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @50, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @49, i32 0, i32 0)), !dbg !42
  %n41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @52, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @51, i32 0, i32 0)), !dbg !42
  %60 = extractvalue %AA %59, 0, !dbg !42
  %n42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @53, i32 0, i32 0), i32 %60), !dbg !42
  %n43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @54, i32 0, i32 0)), !dbg !42
  %n44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @56, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @55, i32 0, i32 0)), !dbg !42
  %61 = extractvalue %AA %59, 1, !dbg !42
  %n45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @57, i32 0, i32 0)), !dbg !42
  %62 = extractvalue [3 x i32] %61, 0, !dbg !42
  %n46 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @58, i32 0, i32 0), i32 %62), !dbg !42
  %n47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @59, i32 0, i32 0)), !dbg !42
  %63 = extractvalue [3 x i32] %61, 1, !dbg !42
  %n48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @60, i32 0, i32 0), i32 %63), !dbg !42
  %n49 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @61, i32 0, i32 0)), !dbg !42
  %64 = extractvalue [3 x i32] %61, 2, !dbg !42
  %n50 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @62, i32 0, i32 0), i32 %64), !dbg !42
  %n51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @63, i32 0, i32 0)), !dbg !42
  %n52 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @64, i32 0, i32 0)), !dbg !42
  %n53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @65, i32 0, i32 0)), !dbg !42
  %65 = extractvalue [2 x %AA] %58, 1, !dbg !42
  %n54 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @67, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @66, i32 0, i32 0)), !dbg !42
  %n55 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @69, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @68, i32 0, i32 0)), !dbg !42
  %66 = extractvalue %AA %65, 0, !dbg !42
  %n56 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @70, i32 0, i32 0), i32 %66), !dbg !42
  %n57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @71, i32 0, i32 0)), !dbg !42
  %n58 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @73, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @72, i32 0, i32 0)), !dbg !42
  %67 = extractvalue %AA %65, 1, !dbg !42
  %n59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @74, i32 0, i32 0)), !dbg !42
  %68 = extractvalue [3 x i32] %67, 0, !dbg !42
  %n60 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @75, i32 0, i32 0), i32 %68), !dbg !42
  %n61 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @76, i32 0, i32 0)), !dbg !42
  %69 = extractvalue [3 x i32] %67, 1, !dbg !42
  %n62 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @77, i32 0, i32 0), i32 %69), !dbg !42
  %n63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @78, i32 0, i32 0)), !dbg !42
  %70 = extractvalue [3 x i32] %67, 2, !dbg !42
  %n64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @79, i32 0, i32 0), i32 %70), !dbg !42
  %n65 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @80, i32 0, i32 0)), !dbg !42
  %n66 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @81, i32 0, i32 0)), !dbg !42
  %n67 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @82, i32 0, i32 0)), !dbg !42
  %n68 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @83, i32 0, i32 0)), !dbg !42
  %71 = extractvalue [2 x [2 x %AA]] %57, 1, !dbg !42
  %n69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @84, i32 0, i32 0)), !dbg !42
  %72 = extractvalue [2 x %AA] %71, 0, !dbg !42
  %n70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @86, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @85, i32 0, i32 0)), !dbg !42
  %n71 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @88, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @87, i32 0, i32 0)), !dbg !42
  %73 = extractvalue %AA %72, 0, !dbg !42
  %n72 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @89, i32 0, i32 0), i32 %73), !dbg !42
  %n73 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @90, i32 0, i32 0)), !dbg !42
  %n74 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @92, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @91, i32 0, i32 0)), !dbg !42
  %74 = extractvalue %AA %72, 1, !dbg !42
  %n75 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @93, i32 0, i32 0)), !dbg !42
  %75 = extractvalue [3 x i32] %74, 0, !dbg !42
  %n76 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @94, i32 0, i32 0), i32 %75), !dbg !42
  %n77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @95, i32 0, i32 0)), !dbg !42
  %76 = extractvalue [3 x i32] %74, 1, !dbg !42
  %n78 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @96, i32 0, i32 0), i32 %76), !dbg !42
  %n79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @97, i32 0, i32 0)), !dbg !42
  %77 = extractvalue [3 x i32] %74, 2, !dbg !42
  %n80 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @98, i32 0, i32 0), i32 %77), !dbg !42
  %n81 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @99, i32 0, i32 0)), !dbg !42
  %n82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @100, i32 0, i32 0)), !dbg !42
  %n83 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @101, i32 0, i32 0)), !dbg !42
  %78 = extractvalue [2 x %AA] %71, 1, !dbg !42
  %n84 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @103, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @102, i32 0, i32 0)), !dbg !42
  %n85 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @105, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @104, i32 0, i32 0)), !dbg !42
  %79 = extractvalue %AA %78, 0, !dbg !42
  %n86 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @106, i32 0, i32 0), i32 %79), !dbg !42
  %n87 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @107, i32 0, i32 0)), !dbg !42
  %n88 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @109, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @108, i32 0, i32 0)), !dbg !42
  %80 = extractvalue %AA %78, 1, !dbg !42
  %n89 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @110, i32 0, i32 0)), !dbg !42
  %81 = extractvalue [3 x i32] %80, 0, !dbg !42
  %n90 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @111, i32 0, i32 0), i32 %81), !dbg !42
  %n91 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @112, i32 0, i32 0)), !dbg !42
  %82 = extractvalue [3 x i32] %80, 1, !dbg !42
  %n92 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @113, i32 0, i32 0), i32 %82), !dbg !42
  %n93 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @114, i32 0, i32 0)), !dbg !42
  %83 = extractvalue [3 x i32] %80, 2, !dbg !42
  %n94 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @115, i32 0, i32 0), i32 %83), !dbg !42
  %n95 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @116, i32 0, i32 0)), !dbg !42
  %n96 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @117, i32 0, i32 0)), !dbg !42
  %n97 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @118, i32 0, i32 0)), !dbg !42
  %n98 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @119, i32 0, i32 0)), !dbg !42
  %n99 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @120, i32 0, i32 0)), !dbg !42
  %n100 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @121, i32 0, i32 0), i8 10), !dbg !43
  br label %ret, !dbg !44
