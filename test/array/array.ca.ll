...
@constarray.4 = internal constant [2 x float] [float 0x3FF19999A0000000, float 0x40019999A0000000], align 4
...
@constarray.6 = internal constant [2 x i64] [i64 4, i64 5], align 4
...
entry:
  ...
  %4 = bitcast [2 x float]* %e to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %4, i8* align 4 bitcast ([2 x float]* @constarray.4 to i8*), i64 8, i1 false)
  ...
  %g = alloca [2 x i64], align 8
  %6 = bitcast [2 x i64]* %g to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %6, i8* align 8 bitcast ([2 x i64]* @constarray.6 to i8*), i64 16, i1 false)
  br label %ret
